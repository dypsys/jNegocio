...
<?= HelperSelect::countries(@$state->filter_countryid, 'filter_countryid', array('class' => 'inputbox necFilter', 'size' => '1', 'onchange' => 'submitform( );'), 'filter_countryid', true); ?>
    ...
    <table class="adminlist">
        <thead>
            <tr>
                ...
                <th class="title"><?php echo jFWGrid::jFWsort('COM_JNEGOCIO_COUNTRY_NAME_LABEL', 'tbl.country_id', @$state->filter_order_Dir, @$state->filter_order); ?></th>
