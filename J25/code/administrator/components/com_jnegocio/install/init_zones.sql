-- ------------------------------------------------------
-- Data for table `#__nec_zones`
-- ------------------------------------------------------
INSERT IGNORE INTO `#__nec_zones` (`zone_id`, `country_id`, `code`, `name`) VALUES
(1, 1, 'BDS', 'Badakhshan'),
(2, 1, 'BDG', 'Badghis'),
(3, 1, 'BGL', 'Baghlan'),
(4, 1, 'BAL', 'Balkh'),
...
(3074, 203, 'K', 'Blekinge'),
(3075, 203, 'W', 'Dalama'),
(3076, 203, 'X', 'Gävleborg'),
(3077, 203, 'I', 'Gotland'),
(3078, 203, 'N', 'Halland'),
(3079, 203, 'Z', 'Jämtland'),
(3080, 203, 'F', 'Jönköping'),
(3081, 203, 'H', 'Kalmar'),
(3082, 203, 'G', 'Kronoberg'),
(3083, 203, 'BD', 'Norrbotten'),
(3084, 203, 'T', 'örebro'),
(3085, 203, 'E', 'östergötland'),
(3086, 203, 'M', 'SkÅne'),
(3087, 203, 'D', 'Södermanland'),
(3088, 203, 'AB', 'Stockholm'),
(3089, 203, 'C', 'Uppsala'),
(3090, 203, 'S', 'Värmland'),
(3091, 203, 'AC', 'Västerbotten'),
(3092, 203, 'Y', 'Västernorrland'),
(3093, 203, 'U', 'Västmanland'),
(3094, 203, 'O', 'Västra Götaland'),
(3095, 204, 'AG', 'Aargau'),
...
(3102, 204, 'GE', 'Genève'),
(3103, 204, 'GL', 'Glarus'),
(3104, 204, 'GR', 'Graubünden'),
(3105, 204, 'JU', 'Jura'),
(3106, 204, 'LU', 'Luzern'),
(3107, 204, 'NE', 'Neuchâtel'),
(3108, 204, 'NW', 'Nidwald'),
(3109, 204, 'OW', 'Obwald'),
...
UPDATE `#__nec_zones` SET `published` = '1';